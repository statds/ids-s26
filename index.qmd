...
+ Whitlow, Mallory
    - Become more comfortable with GitHub and git commands
    - Learn how to troubleshoot errors quickly
    - Better understand programming languages like R/Python to understand when
      to use them
+ Wolven, Alexander
