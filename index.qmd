...
Please use the following table to sign up.
  ...
  ----- | ------------- | ------------------------- 
   ...
   04/08 | Mccabe, Scott | False Discovery Rate Control
   04/08 | Burns, Kyle | Support vector machine
   04/08 | Lacasse, Violet | Gradient boosting machine
   04/13 | Wolven, Alexander | Principal Component Analysis
   04/13 | Zharyy, Sofia |  Automatic Differentiation
   04/13 | Whitlow, Mallory | Multi-dimensional scaling
