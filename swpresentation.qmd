...
**Step 1.** Create the training sets (Described above)
...
**Step 4.** Repeat steps 2 and 3 until you have the intended number of trees with the intended depth

- Use the completed forest to make predictions
```{python}
# Make predictions
