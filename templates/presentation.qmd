...
Raster
- Grid Data(temperature, elevation, satellite)
...
- Main idea
- Supporting evidence
- Visual or data reference (if applicable)

Notes:
- Connect this back to your research question
...
- Source of data
- What the data shows
- Important trends or findings

Notes:
- Highlight only the most important takeaway
