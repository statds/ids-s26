...
This homework asks you to carefully study the case studies from our notes.
...
### Part 1. Community-level suicide risk case study

Answer the following questions based on [01-case-study/01-case-study.qmd](01-case-study/01-case-study.qmd) and [04-case-study/04-case-study-multiple-testing.qmd](04-case-study/04-case-study-multiple-testing.qmd).
...
```{python}
#| code-fold: true
#| code-summary: "Show starter code"
import numpy as np
import pandas as pd
import matplotlib.pyplot as plt
...
```{python}
#| code-fold: true
#| code-summary: "Show code for Question 1"
df1 = simulate_districts(seed=3255)

# TODO: make a scatterplot of rate_per_10k vs population, identify top 10 districts, and report their population and count.

```


2. Repeat the simulation many times
...
```{python}
#| code-fold: true
#| code-summary: "Show code for Question 2"
records = []
...
# TODO: summarize results in a small table and one plot, and explain the instability pattern.  

```

3. Screening districts against a statewide benchmark
...
```{python}
#| code-fold: true
#| code-summary: "Show code for Question 3"
...
# TODO: count how many districts satisfy p < 0.05, and explain why raw p-values can produce "discoveries" even when all districts have the same true rate.

```

---

### Part 2. Simpson's paradox case study

Answer the following questions based on [02-case-study/02_case_study_simpsons_paradox.qmd](02-case-study/02_case_study_simpsons_paradox.qmd).
...
# TODO: compute overall success rates, compute within-difficulty success rates, and show the paradox in a clean table.

# TODO: point out where A > B and where A < B.
```


2. Visualize the reversal
...
# TODO: create one plot for within-difficulty comparison and one plot for overall comparison, and explain the potential misinterpretation from the overall plot alone.
