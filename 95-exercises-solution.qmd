...
+ [Case study: Community risk for adolescent suicide](01-case-study/01-case-study.qmd)
+ [Case study: When the data seem to cheat — Simpson's paradox](04-case-study/04_case_study_simpsons_paradox.qmd)
...
Answer the following questions based on [01-case-study/01-case-study.qmd](01-case-study/01-case-study.qmd).
...
4. Add a few truly elevated districts
   ...
   + Compute how many of the 5 elevated districts are detected with p-value threshold 0.05 or 0.01.
...
```{python}
#| code-fold: true
#| code-summary: "Show code for Question 4"
...
Answer the following questions based on [04-case-study/04_case_study_simpsons_paradox.qmd](04-case-study/04_case_study_simpsons_paradox.qmd).
