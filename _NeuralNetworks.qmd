...
This presentation is prepared by Vincenzo Carbone.
...
![Neural network diagram](nba-player-data/neural-network-diagrams/simple_diagram.png)
...
![Neuron diagram](nba-player-data/neural-network-diagrams/neuron_diagram.png)
...
csv_files = glob.glob("data/nba-player-data/*.csv")
...
players = ["Jaylen Brown","Jayson Tatum", "Jrue Holiday"]
